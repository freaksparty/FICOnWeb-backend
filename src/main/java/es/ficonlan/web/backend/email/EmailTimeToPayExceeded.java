...
public class EmailTimeToPayExceeded extends Email {
	
	public EmailTimeToPayExceeded(String destinatario, String eventName) throws ServiceException {
		super();
		
		String mailConfig  = "mail/mail.properties";
		String mailContent = "mail/TimeToPayExceeded.properties";
