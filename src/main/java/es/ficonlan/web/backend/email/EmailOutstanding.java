...
public class EmailOutstanding extends Email {
	
	public EmailOutstanding (String destinatario, String eventName, int place) throws ServiceException {
		super();
		
		String mailConfig  = "mail/mail.properties";
		String mailContent = "mail/Outstanding.properties";
