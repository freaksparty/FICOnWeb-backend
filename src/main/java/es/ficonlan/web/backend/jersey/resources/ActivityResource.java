...
public class ActivityResource {
	...
	@POST
	public void removeActivity(@HeaderParam("sessionId") long sessionId, @PathParam("activityId") int activityId) throws ServiceException {
	...
	public void changeData(@HeaderParam("sessionId") long sessionId, Activity activityData) throws ServiceException {
		eventService.changeActivityData(sessionId, activityData);
	}
	
	@Path("/setOrganizer/{activityId}/{userId}")
	@POST
	public void setOrganizer(@HeaderParam("sessionId") long sessionId, @PathParam("activityId") int activityId,  @PathParam("userId") int userId) throws ServiceException {
	...
	public List<Activity> getByEvent(@HeaderParam("sessionId") long sessionId, @PathParam("eventId") int eventId, @PathParam("type") String type) throws ServiceException {
		ActivityType t = null;
		if(type!=null){
	...
	@POST
	public void addParticipant(@HeaderParam("sessionId") long sessionId, @PathParam("userId") int userId, @PathParam("activityId") int activityId) throws ServiceException {
		eventService.addParticipantToActivity(sessionId, userId, activityId);
	}
	    
	@Path("/removeParticipant/{activityId}/{userId}")
	@POST
	public void removeParticipant(@HeaderParam("sessionId") long sessionId, @PathParam("userId") int userId, @PathParam("activityId") int activityId) throws ServiceException {
	...
	@GET
	@Produces({MediaType.APPLICATION_JSON})
	public List<User> getActivityParticipants(@HeaderParam("sessionId") long sessionId,  @PathParam("activityId") int activityId) throws ServiceException {
